	...
	<tr>
		...
		<td colspan="3" class="center valignmiddle budgetreport-summary-cell">
			...
			<div class="budgetreport-summary-breakdown">
				...
				<?php if (LmdbAdvancedProjectCompatibility::isShipmentCostEnabled()) { ?><div><span><?php echo $formBudgetReport->textwithtooltip($langs->trans('BudgetCostShipmentsNet'), $langs->trans('BudgetCostChronologyHelp')); ?></span><strong><?php echo price($totalshipmentcost); ?></strong></div><?php } ?>
